...
func _set_metadata(name: String, unit: String, description: String, line_color: String) -> void:
...
func setup_properties(name: String, unit: String, description: String, line_color: String = "red"):
	self._name = name
	self._unit = unit
	self._description = description
	self._line_color_str = line_color
	self.set_line_color(line_color)
	self._set_metadata(self._name, self._unit, self._description, self._line_color_str)
