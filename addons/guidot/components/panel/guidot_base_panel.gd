...
func _ready() -> void:
	...
	self._guidot_stylebox.bg_color = Color(0, 0, 0, 0)
	self._guidot_stylebox.border_color = Color(0, 0, 0, 0)
	self._guidot_stylebox.border_width_left   = 2
	self._guidot_stylebox.border_width_right  = 2
	self._guidot_stylebox.border_width_top    = 2
	self._guidot_stylebox.border_width_bottom = 2
	set_margin_size(margin_val)
	add_theme_stylebox_override("panel", self._guidot_stylebox)
...
func set_margin_size(val: int) -> void:
	self._guidot_stylebox.content_margin_left = val
	self._guidot_stylebox.content_margin_right = val
	self._guidot_stylebox.content_margin_bottom = val
	self._guidot_stylebox.content_margin_top = val
