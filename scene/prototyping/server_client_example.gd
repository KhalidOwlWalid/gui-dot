...
func _ready() -> void:
	...
	Guidot_Utils.setup_data_client_util(self._dc_mouse_cursor, self._mouse_x, "mouse_x", "None", "Example")
	Guidot_Utils.setup_data_client_util(self._dc_mouse_cursor, self._mouse_y, "mouse_y", "None", "Example")
	Guidot_Utils.setup_data_client_util(self._test_data, self._test, "test", "None", "Example")
	Guidot_Utils.setup_data_client_util(self._test_data, self._test2, "test", "None", "Example")
